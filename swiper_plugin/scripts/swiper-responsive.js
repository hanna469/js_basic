...
const nikiSwiper = new Swiper(season[0], {
    ...
    breakpoints:{
        640:{}, //640 이상일 때
        768:{slidesPerView:3,}, //768 이상일 때
        1024:{slidesPerView:4,}, //1024 이상일 때
    },
});
const converseSwiper = new Swiper(season[1], {
    ...
    breakpoints:{
        640:{}, //640 이상일 때
        768:{slidesPerView:3,}, //768 이상일 때
        1024:{slidesPerView:4, spaceBetween:30,}, //1024 이상일 때
    },
});
...
// 2. 컨버스 탭 제목 클릭 (active 변경 이동)-> 컨버스 보이기, 나이키 숨기기
...
// 3. 나이키 탭 제목 클릭 (active 변경 이동)-> 컨버스 숨기기, 나이키 보이기
