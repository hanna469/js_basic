...
//typeResult 변수 생성
//Boolean 내장함수 활용 data1 변수에 들어간 논리데이터 종류 확인
//typeResult 대입
...
let x = 10;
let y = 20;
let result = x !== y; //=(대입) ==(피연산자 같은가 비교연산) !=(다른가)
console.log(`result => ${result}`);

if(result) console.log('resule는 참'); // 실행이 한 줄이면 중괄호 생략가능
// if(result) {console.log('resule는 참');}
...
// if (x==y ) console.log(;)
    ...
    w -= h; //w = w-h; w1920 - h1080 // w=840 h=1080
